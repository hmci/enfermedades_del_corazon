...
El conjunto de datos consta de un total de 14 atributos entre discretos y continuos que recogen información básica de pacientes como edad, sexo y también almacena el resultado de un conjunto de exámenes de salud realizados, obteniendo por ejemplo el nivel de colesterol en la sangre, nivel de azúcar en la sangre, etc.

El dataset es importante porque tiene como propósito predecir a partir del conjunto de atributos si un paciente determinado es propenso o no a sufrir de algún tipo de enfermedad cardiaca, se pretende responder preguntas como 
¿cual es la edad promedio para sufrir este tipo de enfermedad?
¿Cual  es la probabilidad de  esta enfermedad con relacion al atributo sexo?
